...
def home():
    return "<h4>Hello Sanket!</h4><p>This is my first flask project.</p>"  # This text displays in the browser

@app.route('/about')  # Decorator that maps URL '/' (home page) to this function
def abt():
    return "<h4>About Me!</h4><p>I am student.</p>"  # This text displays in the browser
